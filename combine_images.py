...
dir = "./figs_new/"#heatmaps/"#"/Users/christopherackerman/Desktop/"#
#image_files = [f'{dir}t1.png', f'{dir}t4.png', f'{dir}t2.png', f'{dir}t3.png']
#image_files = [f'{dir}Assistant-User_Vector_Activations_Over_20_Shots:_Nice.png', f'{dir}Assistant-User_Vector_Activations_Over_20_Shots_With_Roles_Alias:_Nice.png', f'{dir}Assistant-User_Vector_Activations_Over_20_Shots_With_Names_Alias:_Nice.png',
#               f'{dir}Assistant-User_Vector_Activations_Over_20_Shots:_Harmless.png', f'{dir}Assistant-User_Vector_Activations_Over_20_Shots_With_Roles_Alias:_Harmless.png', f'{dir}Assistant-User_Vector_Activations_Over_20_Shots_With_Names_Alias:_Harmless.png']
#image_files = [f'{dir}cnn_trimmed_llama3_8bbase2.png',f'{dir}xsum_trimmed_llama3_8bbase2.png', f'{dir}dolly_trimmed_llama3_8bbase2.png', f'{dir}sad_trimmed_llama3_8bbase2.png']
image_files = [f'{dir}steering_heatmap_mixed2_rot.png',f'{dir}steering_heatmap_qa_rot.png']
output_file = 'steering_heatmaps_rotated.png'
